...
python main.py --local_model_name "ResNet18" --num_train_samples 11000 --alpha_dirichlet 10 --rounds 30 --num_synth_img_per_class 100 --global_epochs 10 --output_name "_ResNet18_10K_alpha10_synth100_ge10_"
