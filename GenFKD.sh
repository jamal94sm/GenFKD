...
python main.py --local_model_name "ResNet18" --dataset "cifar10" --num_train_samples 11000 --alpha_dirichlet 1 --rounds 30 --output_name "_ResNet18_10K_alpha1_synth100_T4"
