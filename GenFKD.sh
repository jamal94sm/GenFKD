...
#SBATCH --time=20:00:00               # job time limit (HH:MM:SS)
...
python main.py --local_model_name "EfficientNet" --dataset "cifar10" --num_train_samples 33000 --alpha_dirichlet 0.1 --rounds 50 --num_synth_img_per_class 300 --output_name "_EN_30K_alpha0.1_synth300_"
