...
#SBATCH --time=15:00:00               # job time limit (HH:MM:SS)
...
python main.py --local_model_name "ResNet18" --dataset "cifar10" --num_train_samples 11000 --alpha_dirichlet 10 --rounds 30 --output_name "_ResNet18_10K_alpha10_synth100_T4"
