...
python main.py --local_model_name "ResNet18" --num_train_samples 11000 --alpha_dirichlet 0.1 --rounds 30 --num_synth_img_per_class 100 --global_epochs 1 --num_prompts 4 --output_name "_ResNet18_10K_alpha0.1_synth100_ge1_np4"
