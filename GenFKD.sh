...
python main.py --local_model_name "ResNet18" --num_train_samples 10000 --alpha_dirichlet 1 --num_synth_img_per_class 100 --output_name "_ResNet18_10K_alpha1_synth100_globalround_5"
