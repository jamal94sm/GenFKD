...
python main.py --local_model_name "ResNet18" --num_train_samples 11000 --alpha_dirichlet 1 --rounds 40 --num_synth_img_per_class 200 --output_name "_ResNet18_10K_alpha1_synth200_T3_"
