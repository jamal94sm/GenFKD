...
def main():
    ...
    public_data = MyUtils.load_synthetic_images(name_classes, image_size=distributed_dataset[0]["train"]["image"].shape[-2:], data_dir=synth_img_dir, max_per_class=args.num_synth_img_per_class)
